...
const AddFeed = () => {
    ...
    const onClickSave = (e) => {
        ...
        form.append("writerId", localStorage.getItem("userId"));
        ...
        <>
            ...
            <FloatBtnContainer>
                <RoundBtn
                    ...
                    style={{
                        width: "160px",
                        backgroundColor: themeColorset.pointColor,
                    }}
                >
                    {" "}
                    감각정보 추가하기
                </RoundBtn>
                <RoundBtn onClick={onClickSave} style={{ width: "200px" }}>
                    저장
                </RoundBtn>
            </FloatBtnContainer>
