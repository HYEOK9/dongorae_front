...
const SetUserEmail = ({
    ...
    return (
        <>
            ...
            <WarnInfo>
                {pwdStarted && !pwdIsValid ? "영문, 숫자 조합 6~16자" : ""}
            </WarnInfo>
        </>
    );
};
...
flex justify-center relative w-full mb-1
`;
...
h-4 text-[10px] text-red-500 mb-1
`;
